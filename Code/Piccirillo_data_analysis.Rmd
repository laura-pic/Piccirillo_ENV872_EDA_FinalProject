...
# using single linear regressions because continuous response/continuous explanatory
...
```{r}
# is oxygen helping to control organic selenide and maybe the other species too? Specifically looking here in 2 locations within the OMZ.
