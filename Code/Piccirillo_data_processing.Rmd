...
# choose locations of interest - picked points with nearly complete depth profiles of oxygen and filtered them by lat/long - picked ones closest to Peruvian coast as this is where OMZ is - only 2 really met requirements
oxygen_location1 <- oxygen_clean2 %>%
  filter(LATITUDE == -12.0057 & LONGITUDE == -79.1952)

#long of -77.818 vs -77.8181 assumed to be the same here
oxygen_location2 <- oxygen_clean2 %>%
  filter(LATITUDE == -12.0448 & LONGITUDE == -77.818)
