...
# rounding lat/long to 3 decimal places to better match up Se data with oxygen data - this is sufficient for this analysis, as this is still within 360 ft and the ship length was 274 ft.
...
oxygen_clean2 <- oxygen_clean %>% filter(DepSM <= 500)
